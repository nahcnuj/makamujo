...
export const app = new Hono()
  ...
  .get('/console/frontend.js', async (c) => await serveConsoleAsset(c.req.raw) ?? await serveConsoleAppHtml())
  .get('/console/frontend.css', async (c) => await serveConsoleAsset(c.req.raw) ?? await serveConsoleAppHtml())
