 ...
 */
export const installDeterministicEventSource = ({ responseText }: { responseText: string }) => {
  ...
  (window as unknown as { EventSource: typeof DeterministicEventSource }).EventSource = DeterministicEventSource;
};
