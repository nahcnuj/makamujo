/**
 * Local fixture for console UI mock state.
 * Copied from tests/fixtures/agentStateResponseMock.ts so the console
 * frontend build does not try to resolve files under /tests when
 * producing a production bundle.
 */
