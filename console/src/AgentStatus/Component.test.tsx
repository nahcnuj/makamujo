...
import { AgentStatus, createAgentStateWebSocketUrl } from "./Component";
import { GameStatusSection } from "./sections/GameStatusSection";
import { LiveDeliveryStatusSection } from "./sections/LiveDeliveryStatusSection";
import { MarkovModelStatusSection } from "./sections/MarkovModelStatusSection";
...
describe("AgentStatus category sections (sanity)", () => {
...
describe("createAgentStateWebSocketUrl", () => {
    it("builds a wss URL from a wss base URL", () => {
        ...
        expect(createAgentStateWebSocketUrl("wss://127.0.0.1/console/")).toBe("wss://127.0.0.1/console/api/ws");
    });
});
